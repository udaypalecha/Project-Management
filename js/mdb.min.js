! function(t, e) {
	...
	return n = [function(t, e, n) {
		...
		var _r = mr;
		v = ".".concat("bs.toast");
		const vr = "mouseover".concat(v), br = "mouseout".concat(v), yr = "focusin".concat(v), wr = "focusout".concat(v), Er = "hide".concat(v), xr = "hidden".concat(v), Cr = "show".concat(v), Ar = "shown".concat(v), Tr = "show", Or = "showing", Lr = { animation: "boolean", autohide: "boolean", delay: "number" },
